...
function sep_LDA_runs = Separate_Runs_LDA_Approach2b(i)
...
%     c) Modality Switch Effect:
    ...
    outname = strcat('LDA_Approach2b_Results','_',i,'.mat')

    save outname Azloo2b_sf Azloo2b_con Azloo2b_mse Azsig2b_sf Azsig2b_con Azsig2b_mse Y2b_sf Y2b_con Y2b_mse a2b_sf a2b_con a2b_mse v2b_sf v2b_con v2b_mse D2b_sf D2b_con D2b_mse
